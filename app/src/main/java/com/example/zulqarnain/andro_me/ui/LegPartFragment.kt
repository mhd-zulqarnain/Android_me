...
class LegPartFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var view: View = inflater.inflate(R.layout.fragement_leg_part, container, false)
        var imageView: ImageView
        imageView = view.findViewById(R.id.leg_image_view)
        imageView.setImageResource(utils.getleg().get(imageIndex))
