...
class HeadPartFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var view: View = inflater.inflate(R.layout.fragement_head_part, container, false)
        var imageView: ImageView
        imageView = view.findViewById(R.id.head_image_view)
        imageView.setImageResource(utils.getHead().get(imageIndex))
